...
import { buildTargetImageCatalog, existingFilePathFor, getTargetPaths, PROJECT_ROOT } from './image-catalog.js';
  ...
  buildTargetImageCatalog()
    .then(({ entries }) => {
      ...
      if (missingFiles.length > 0) {
        ...
        fs.writeFileSync(path.join(reportsDir, 'missing-images.json'), JSON.stringify(payload, null, 2), 'utf8');
      }
